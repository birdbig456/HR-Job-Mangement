                    ...
                    <Table style={{ overflowX: "scroll" }}>
                      <TableHead>
                        <TableRow>
                          ...
                          <TableCell>Job Directory</TableCell>
                          <TableCell>JE</TableCell>
                          <TableCell>JC</TableCell>
                          <TableCell>JTA</TableCell>
                          <TableCell>Person in Job</TableCell>
                      ...
                      <TableBody>
                        ...
                        {results
                          .filter((item) => {
                            ...
                            if (HR) {
                              TypeConditions.push("HR");
                            }
                            if (Developer) {
                              TypeConditions.push("Developer");
                            }
                            if (Active) {
